...
color_dict = {"pink": (1.0, 0.0, 0.5, 1),
              "blue": (0.0, 0.5, 1.0, 1), 
              "orange": (1.0, 0.5, 0.0, 1),
              "salmon": (1.0, 0.75, 0.75, 1),
              "gray": (0.5, 0.5, 0.5, 1),}
...
# # Add lasso highlighting for multiple substructures
# draw_multi_matches(d, mol, matches,
#                    r_min=0.3, r_dist=0.12, relative_bond_width=0.5,
#                    color_list=color_dict.values(), line_width=2)
